...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Cajas02))
        ...
        Me.tipon.Items.AddRange(New Object() {"JT", "TRECENTO", "ZUNTEX"})
...
#End Region
    Private Sub Cortes_status(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        llena_combos(tipon, "SELECT * FROM TIPOS_PRENDA", "TIPO_PRENDA")
        Try
            tipon.Items.Remove("Primeras")
    ...
    Private Sub setea_fg()
        ...
        fg.Rows.Fixed = 1
        fg.Rows(0).Height = 30
        llena_combos(corte, "SELECT DISTINCT CORTE FROM CAJAS01 WHERE ESTADO IN ('A','P') AND SECCION = '" & sec & "' ORDER BY CORTE", "CORTE")
    End Sub
    ...
    Private Sub llena_corte()
        ...
        llena_combos(cajad, "SELECT DISTINCT CAJA FROM CAJAS01 WHERE CORTE = '" & corte.Text & "' AND UNIDADES > 0 ORDER BY CAJA", "CAJA")
    ...
    Private Sub graba_datos()
        ...
        Try
            ...
            For i = 1 To fg.Rows.Count - 1
                ...
                ts = tipon.Items.IndexOf(fg(i, 5)) + 1
                busca = ts
                If ts = 0 Then
                    tipo = "P"
                ElseIf InStr(busca, terceras) > 0 Then
                    tipo = "T"
                Else
                    tipo = "S"
                End If
