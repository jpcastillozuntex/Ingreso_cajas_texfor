...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.corte.TabIndex = 0
        Me.ToolTip1.SetToolTip(Me.corte, "Corte.")
        '
        'cajad
        '
        ...
        Me.sigue.Location = New System.Drawing.Point(459, 129)
        Me.sigue.Name = "sigue"
        Me.sigue.Size = New System.Drawing.Size(69, 51)
        Me.sigue.TabIndex = 7
        ...
        Me.Cancela.Location = New System.Drawing.Point(1057, 24)
        ...
        Me.cajan.Location = New System.Drawing.Point(227, 39)
        Me.cajan.Name = "cajan"
        Me.cajan.Size = New System.Drawing.Size(216, 33)
        Me.cajan.TabIndex = 5
        Me.ToolTip1.SetToolTip(Me.cajan, "Tipo de Prenda")
        '
        'tipod
        '
        ...
        Me.unidn.Location = New System.Drawing.Point(227, 85)
        ...
        Me.graba.Location = New System.Drawing.Point(979, 24)
        Me.graba.Name = "graba"
        ...
        Me.fg.Location = New System.Drawing.Point(26, 424)
        Me.fg.Name = "fg"
        Me.fg.Rows.DefaultSize = 21
        Me.fg.Size = New System.Drawing.Size(1120, 413)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(535, 325)
        ...
        Me.Label11.Location = New System.Drawing.Point(7, 266)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(591, 92)
        Me.GroupBox2.Name = "GroupBox2"
        Me.GroupBox2.Size = New System.Drawing.Size(555, 325)
        ...
        Me.Label8.Size = New System.Drawing.Size(198, 36)
        ...
        Me.CheckBox1.Location = New System.Drawing.Point(591, 33)
        Me.CheckBox1.Name = "CheckBox1"
        Me.CheckBox1.Size = New System.Drawing.Size(216, 24)
        Me.CheckBox1.TabIndex = 99
        Me.CheckBox1.Text = "Crear una Caja Nueva"
        ...
        Me.ClientSize = New System.Drawing.Size(1219, 696)
...
#End Region
    ...
    End Sub
    Private Sub cajan_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cajan.KeyPress
    ...
    Private Sub cajad_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cajad.SelectedIndexChanged
        ...
        Else
            cajan.Items.Clear()
            cajan.Items.Add("NUEVA")
            cajan.SelectedIndex = 0
        End If
    End Sub
    ...
    Private Sub graba_datos()
        ...
        Try
            ...
            For i = 1 To fg.Rows.Count - 1
                ...
                strsql = "UPDATE CAJAS04 SET UNIDADES = UNIDADES + '" & fg(i, 6) & "' WHERE CAJA = '" & fg(i, 5) & "' AND CORTE = '" & corte.Text & "' AND TALLA = '" & fg(i, 3) & "' AND TIPO = '" & fg(i, 2) & "'"
                comando.CommandText = strsql
                afectados = comando.ExecuteNonQuery()

                If afectados = 0 Then
                    strsql = "INSERT INTO CAJAS04 (CAJA,CORTE,TALLA,TIPO,UNIDADES,FECHA,QUIEN) VALUES ('" &
                                                   fg(i, 5) & "','" & corte.Text & "','" &
                                                   fg(i, 3) & "','" & fg(i, 2) & "','" &
                                                   fg(i, 6) & "','" & fg(i, 9) & "','" & obj.usuario & "')"
                    comando.CommandText = strsql
                    afectados = comando.ExecuteNonQuery()
                End If
                ...
                strsql = "INSERT INTO CAJAS03 (TIPO,CAJA_D,CORTE_D,TALLA_D,TIPO_D,CAJA_A,CORTE_A,TALLA_A,TIPO_A,UNIDADES,FECHA,QUIEN,ORDEN) VALUES ('" &
                                              "C','" & fg(i, 1) & "','" & corte.Text & "','" & fg(i, 3) & "','" & fg(i, 2) & "','" & fg(i, 5) & "','" & corte.Text & "','" &
                                              fg(i, 3) & "','" & tipod.Text & "','" &
                                              fg(i, 6) & "',GETDATE(),'" &
                                              obj.usuario & "','" & fg(i, 7) & "')"
                comando.CommandText = strsql
